...
export default function CreateReview({ closeModal }) {
    ...
    const handlePhotosUpload = (e) => {
        ...
        axios
            .post(`http://3.36.132.223:9000/product/reviewPhotos?maxFiles=${files.length}`, formData, {
                headers: {
    ...
    const handleSubmit = (e) => {
        ...
        if (reviewSubjectRef.current.value === "") {
            ...
            axios
                .post('http://3.36.132.223:9000/product/review', data)
                .then(res => {
        ...
        <form onSubmit={handleSubmit}>
                ...
                <div>
                        {previewList && previewList.map((fileName, idx) => (
                            <img key={idx}
                                src={`http://3.36.132.223:9000/upload_review_photos/${fileName}`
                                }
                            style={prevImg}
                            />
                        ))}
