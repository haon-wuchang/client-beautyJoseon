...
export function useCart() {
    ...
    ********************************************/
    const getCartList = async () => {
        ...
        const result = await axios.post("http://3.36.132.223:9000/cart/items", { "id": id });
    ...
    ********************************************/
    const saveToCartList = async (formData) => {
        const result = await axios.post("http://3.36.132.223:9000/cart/add", formData);
    ...
    ********************************************/
    const updateCartList = async (cid, type, qty) => {
        const result = await axios.put('http://3.36.132.223:9000/cart/updateQty',
    ...
    ********************************************/
    const deleteCartItem = async(cid) => {
        const result = await axios.delete("http://3.36.132.223:9000/cart/deleteItem", {data: {"cid": cid}});
        result.data.result_rows && getCartList();
    }
    ...
    ********************************************/
    const clearCart = async() => {
        const result = await axios.delete("http://3.36.132.223:9000/cart/deleteAll");
        result.data.result_rows && getCartList();
    }
    ...
    ********************************************/
    const getSelectItemPrice = async(cids) => {
        const result = await axios.post("http://3.36.132.223:9000/cart/selectItems", {"cids": cids});
    ...
    ********************************************/
    const orderSelectItem = async(cid) => {
        const result = await axios.post("http://3.36.132.223:9000/cart/orderSelect", {"cid": cid});
    }
    ...
    ********************************************/
    const paymentKakaoPay = async() => {
        ...
        const response = await axios.post("http://3.36.132.223:9000/payment/qr", {
                        id:id,
                        item_name: pname,
