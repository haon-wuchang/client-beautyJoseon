...
export function useProduct() {
    ...
    ********************************************/
            ...
            const getReview = async (pid) => {
                const result = await axios.post("http://3.36.132.223:9000/product/getReview", { pid });
    ...
    ********************************************/
    ...
    const getWishList = async () => {
        const { data } = await axios.post("http://3.36.132.223:9000/product/getWishList", {
    ...
    ********************************************/
    ...
    const addWishList = async (pid) => {
        ...
        if (!wishList.includes(pid)) {
            wishList.push(pid);
            await axios.post("http://3.36.132.223:9000/product/addWishList", {
                id,
                wishList,
            });
    ...
    ********************************************/
    const getCategoryItems = async(category) => {
        ...
        try {
            const res = await axios.post('http://3.36.132.223:9000/product/list', {
    ...
    ********************************************/
    const getSubCateItems = async(category) => {
        ...
        try {
            const res = await axios.post('http://3.36.132.223:9000/product/subList', {"category": category});
