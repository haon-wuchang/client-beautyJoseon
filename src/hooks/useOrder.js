...
export function useOrder() {
    ...
    ********************************************/
    const getCartAll = async() => {
        ...
        const result = await axios.post("http://3.36.132.223:9000/order/all", {"id": id});
    ...
    ********************************************/
    const getSelectItems = async() => {
        ...
        const result = await axios.post("http://3.36.132.223:9000/order/select", formData);
    ...
    ********************************************/
    const updateDelivery = async(formData) => {
        const result = await axios.post("http://3.36.132.223:9000/order/updateDelivery", formData);
    ...
    ********************************************/
    const saveToOrder = async() => {
        ...
        try {
            const result = await axios.post("http://3.36.132.223:9000/order/saveOrder", formData);
    ...
    ********************************************/
    const deleteItems = async() => {
        ...
        const result = await axios.delete("http://3.36.132.223:9000/order/deleteItems", {data: {"cids": cids}});
    ...
    ********************************************/
    const paymentKakaoPay = async() => {
        ...
        const response = await axios.post("http://3.36.132.223:9000/payment/kakaoQr", {
                        id:id,
                        item_name: pname,
