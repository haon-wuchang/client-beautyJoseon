...
export default function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        if(validate()){
            ...
            axios.post('http://3.36.132.223:9000/login',formData)
                .then(res => {
    ...
    const NaverLogin = () => {
        ...
        const callbackUrl = "http://beauty-client.s3-website.ap-northeast-2.amazonaws.com/signup/redirect/naver"; // 네이버 개발자 센터에 등록한 URL
    ...
    const kakaoLogin = () =>{
        ...
        const redirect_uri = 'http://beauty-client.s3-website.ap-northeast-2.amazonaws.com/signup/redirect/kakao';
